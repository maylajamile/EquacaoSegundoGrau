...
public class telaEquacao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblDelta.setForeground(new java.awt.Color(204, 102, 0));
        lblDelta.setText("0");

        lblRaiz.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        lblRaiz.setForeground(new java.awt.Color(204, 102, 0));
        lblRaiz.setText("0");
    ...
    private void btnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcActionPerformed
        ...
        if (d<0){
            lblRaiz.setText("Nao ha raiz real");
        }else{
            lblRaiz.setText("Ha raiz real");
        }
